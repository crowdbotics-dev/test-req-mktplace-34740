"""
Django settings for test_req_mktplace_34740 project.
...
ROOT_URLCONF = 'test_req_mktplace_34740.urls'
...
WSGI_APPLICATION = 'test_req_mktplace_34740.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_req_mktplace_34740 API",
    "DESCRIPTION": "API documentation for test_req_mktplace_34740 App",
    "VERSION": "v1",
}
