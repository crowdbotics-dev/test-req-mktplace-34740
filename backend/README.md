...
## Project Structure
    ...
    ├── test_req_mktplace_34740  # Django project configurations
...
1. Clone this repo and `cd test_req_mktplace_34740`
...
2. Clone this repo and `cd test_req_mktplace_34740`
